...
<section class="sm:px-16 px-6 sm:py-16 py-10 max-w-7xl mx-auto relative z-0">
	<span class="hash-span" id="work">&nbsp;</span>
		...
		<div class="vertical-timeline vertical-timeline--animate vertical-timeline--two-columns">
			<div id="" class="vertical-timeline-element">
				<span class="vertical-timeline-element-icon bounce-in" style="background: rgb(56, 62, 86);"
					><div class="flex justify-center items-center w-full h-full">
						<img src="/assets/starbucks-af2a76fc.png" class="w-[60%] h-[60%] object-contain" />
					</div></span
				>
				<div
				...
				>
					...
					<div>
						...
						<p class="text-secondary text-[16px] font-semibold" style="margin: 0px;">Starbucks</p>
					</div>
					<ul class="mt-5 list-disc ml-5 space-y-2">
						...
						<li class="text-white-100 text-[14px] pl-1 tracking-wider">
							Collaborating with cross-functional teams including designers, product managers, and
							other developers to create high-quality products.
						</li>
						<li class="text-white-100 text-[14px] pl-1 tracking-wider">
			...
			<div id="" class="vertical-timeline-element">
				<span
					...
					><div class="flex justify-center items-center w-full h-full">
						<img src="/assets/tesla-4c857950.png" class="w-[60%] h-[60%] object-contain" />
					</div></span
				>
				<div
					class="vertical-timeline-element-content bounce-in"
				...
				>
					...
					<div>
						...
						<p class="text-secondary text-[16px] font-semibold" style="margin: 0px;">Tesla</p>
					</div>
					<ul class="mt-5 list-disc ml-5 space-y-2">
						<li class="text-white-100 text-[14px] pl-1 tracking-wider">
							Developing and maintaining web applications using React.js and other related
			...
			<div id="" class="vertical-timeline-element">
				<span class="vertical-timeline-element-icon bounce-in" style="background: rgb(56, 62, 86);"
					><div class="flex justify-center items-center w-full h-full">
						<img src="/assets/shopify-c0fdbc80.png" class="w-[60%] h-[60%] object-contain" />
					</div></span
				>
				<div
					class="vertical-timeline-element-content bounce-in"
				...
				>
					...
					<div>
						...
						<p class="text-secondary text-[16px] font-semibold" style="margin: 0px;">Shopify</p>
					</div>
					<ul class="mt-5 list-disc ml-5 space-y-2">
						<li class="text-white-100 text-[14px] pl-1 tracking-wider">
							Developing and maintaining web applications using React.js and other related
			...
			<div id="" class="vertical-timeline-element">
				...
				<div
					class="vertical-timeline-element-content bounce-in"
					style="background: rgb(29, 24, 54); color: rgb(255, 255, 255);"bounce-in
				>
					<div
						class="vertical-timeline-element-content-arrow"
						style="border-right: 7px solid rgb(35, 38, 49);"
					...
					<div>
						...
						<p class="text-secondary text-[16px] font-semibold" style="margin: 0px;">Meta</p>
					</div>
					<ul class="mt-5 list-disc ml-5 space-y-2">
						<li class="text-white-100 text-[14px] pl-1 tracking-wider">
							Developing and maintaining web applications using React.js and other related
